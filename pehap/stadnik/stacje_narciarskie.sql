...
--
-- Host: localhost
-- Czas generowania: 21 Paź 2017, 22:50
...
--
-- CREATE DATABASE IF NOT EXISTS `stacje_narciarskie` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
-- USE `stacje_narciarskie`;
-- --------------------------------------------------------
