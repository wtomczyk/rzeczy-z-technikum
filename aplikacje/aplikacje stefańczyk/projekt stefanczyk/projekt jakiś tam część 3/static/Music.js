...
var Music = {
    ...
    wczesniej: (pliki,granyteraz,info,tabela) =>{
        if(granyteraz!=null){
        console.log(pliki)
        ...
        if(tabela==undefined){
            ...
            if(wyznacznikmiejsca>-1){
                granyteraz=pliki[wyznacznikmiejsca]
                ui.przyciskinadol(pliki, granyteraz,tabela[wyznacznikmiejsca],tabela)
                $("#audio").trigger("pause");
                $("#audio").html('<source src="static/mp3/'+tabela[wyznacznikmiejsca]+'/'+pliki[wyznacznikmiejsca]+'" id="audio_src" type="audio/mp3" />')
                $("#audio").trigger('load');
                $("#audio").trigger("play");
                Music.playing = true
                $("#play_button").attr("src", "/static/kontrolki/stop.png")
    ...
    dalej: (pliki,granyteraz,info,tabela) =>{
        if(granyteraz!=null){
        if(tabela!=undefined){
            console.log(pliki)
            console.log(granyteraz)
